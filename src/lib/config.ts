...
export const TALOS_GATEWAY_URL = process.env.TALOS_GATEWAY_URL || 'http://localhost:8001';
export const TALOS_AUDIT_URL = process.env.TALOS_AUDIT_URL || 'http://localhost:8002';
export const TALOS_CONFIGURATION_URL = process.env.TALOS_CONFIGURATION_URL || 'http://localhost:8003';
